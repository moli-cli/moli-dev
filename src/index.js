 ...
 */
function getHelp() {
    log.success("moli dev command help info");
    log.log("");
    log.log("  Usage : ");
    log.log("");
    ...
    log.log("    --custom [type]    run dev in user custom [type]");
...
module.exports = {
    plugin: function (options) {
        ...
        log.info("moli dev env:" + process.env.NODE_MOLIENV);
